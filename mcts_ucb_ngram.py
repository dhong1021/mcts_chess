...
def rollout(curr_node, first_roll):
    ...
    if epsgrd > 3 and first_roll:
        ngram_move = ngram_enhanced(curr_node)
...
##########흑일때 ngram 끄기###########
            reward,state = rollout(ex_child, False)
...
for i in range(7):
    ...
    print('white avr: ', white_avr_time, ' black avr: ', black_avr_time)
